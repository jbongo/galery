...
<body style="background-color: @auth #b0bcc9; @else #e2d6e2 @endauth">
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
    ...
    @admin
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{ ( route('category.create') )}}" href="#" id="navbarDropdownGestCat" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    @lang('Administration')
                </a>
